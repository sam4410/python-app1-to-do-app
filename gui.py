...
add_button = Fsg.Button(size=1, image_source='add.png', mouseover_colors='LightBlue2', key="Add")
list_box = Fsg.Listbox(values=utility_funcs.get_todos(), key="todos",
                       enable_events=True, size=[45, 10])
edit_button = Fsg.Button("Edit")
complete_button = Fsg.Button(size=1, image_source='complete.png', mouseover_colors='LightBlue2', key="Complete")
